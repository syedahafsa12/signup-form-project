            ...
            <div className="left-top flex h-full">
                ...
                <div className="margin-l h-full md:w-1/2 flex items-center ml-20">
                    ...
                    <div className="box p-4 w-full max-w-sm">
                        <center>
                            <h2 className="text1 mb-3 text-lg ">Reset password</h2>
                            <p className="text2 mb-3  text-gray-700 text-sm ">Enter your email address to get instructions for resetting your password.</p>
                        </center>
                        ...
                        <form action="" onSubmit={handleSubmit}>
                            <div className="container space-y-3">
                                ...
                                <p className='mt-1 text-red-500 text-xs flex' >Hmmm. We couldn&apos;t find an account with that email.
                                </p>
                                <div className="mt-3">
                                    <button className="button text- text-sm  rounded-full text-white" type="submit" onClick={() => router.push('/reset-email')}>Reset Password</button>
                                </div>
                            </div>
                        </form>
